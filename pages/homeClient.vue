<template>
        ...
        <v-col class="py-0">
          ...
          >
            <v-list-item-content>
              ...
              <v-list-item-subtitle v-text="userOnline.entity"></v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
        </v-col>
      </v-row>
  ...
  <br>
  <br>
  <p id="parCentral"> ¡Bienvenido, cliente!
Este es tu home, acá, podrás tener acceso a las funcionalidades que vienen con tu
rol: podrás editar tu perfil, mirar los contratos activos y terminados, 
y también podrás darle una reseña a los servicios adquiridos, todo esto para que 
puedas sacarle el mayor provecho a nuestra página. </p> 
    </div>
  </div>
</template>
<style>
