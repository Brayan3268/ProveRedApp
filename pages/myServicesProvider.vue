<template>
  <div>
    <h1>Mis servicios activos</h1>  
      ...
      ></v-text-field>
    <v-col cols="12" md="4" >
      <v-btn class="md- 600 mt-6 px-md-6" @click="editService()" v-if="editing">Editar servicio</v-btn>
    </v-col>
...
export default {
  ...
  methods: {
    ...
    deleteService(service){
      ...
      var posToDelete = this.services.findIndex((x) => x.idService == service.idService);
      if(posToDelete != -1){
