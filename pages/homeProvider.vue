<template>
  <!-- se carga el Home del proveedor el cual dará paso al menú de navegación y aplicación del proveedor-->
  <div >
    <h1>Proveedor</h1>
    <br>
    <br>
        ...
        <v-col class="py-0">
          ...
          >
            <v-list-item-content>
              ...
              v-text="userOnline.fullname"> 
              </v-list-item-title>
              <v-list-item-subtitle v-text="userOnline.typeprovider"></v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
        </v-col>
      </v-row>
  ...
  <br>
  <br>
  <p id="parCentral"> ¡Bienvenido, proveedor!
      Este es tu home, acá, podrás tener acceso a las funcionalidades que vienen con tu
      rol: podrás crear servicios, aceptar contratos, editar tu perfil, y en general, 
      podrás estar al tanto de todas tus acciones en nuestra página, para que puedas 
      sacarle el mayor provecho. </p> 
    </div>
  </div>
</template>
<style>
